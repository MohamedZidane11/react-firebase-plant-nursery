...
const NurseriesManager = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editing) {
        await updateDoc(doc(db, 'nurseries', editing), trimmedData);
        alert('تم تحديث المشتل!');
      } else {
        await addDoc(collection(db, 'nurseries'), trimmedData);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Add/Edit Form */}
        {showForm && (
          <div className="bg-white p-8 rounded-2xl shadow-lg mb-8 border border-green-100">
